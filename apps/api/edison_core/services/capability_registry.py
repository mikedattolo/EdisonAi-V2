    ...
    def snapshot(self) -> CapabilityStatus:
        ...
        plugins = [
            PluginIntegrationRecord(
                ...
                setup_commands=[
                    "export EDISON_API_URL=http://192.168.1.34:8000",
                    "python scripts/export-edison-codex-plugin.py --out /tmp/edison-codex-plugin.zip",
                    "codex plugin add edison@personal",
                ],
                detail="Codex plugin bundle exporter is available and includes Edison MCP servers plus a reusable skill.",
            ...
            PluginIntegrationRecord(
                ...
                detail="Claude-style skill and MCP bundle exporter is available; credentials stay in local settings.",
